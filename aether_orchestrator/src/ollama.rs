...
// ---------------------------------------------------------------------------
//
// NOTE: Single-pass tool-calling was removed from the conversation path
// (commit 7aa7168) because live testing showed it degraded response quality
// and was slower than the deterministic label router. These types are kept
// (commented out) in case tool-calling is re-implemented differently later.
//
...
impl OllamaClient {
    ...
    ///
    /// NOTE: Disabled (commented out) — see the tool-calling note above. Kept
    /// for reference in case tool-calling is re-implemented differently.
